...
GOLDEN_PARTIES: dict[str, tuple[float, float, float]] = {
    "ANC": (23.0512, 12.6682, 34.3572),
    "DA": (26.5895, 20.8618, 32.5586),
    "EFF": (10.1148, 2.9833, 19.6278),
    "ASA": (11.5771, 4.8780, 20.7135),
    "MK": (7.9179, 2.2054, 16.1764),
    "PA": (4.7189, 2.9712, 6.6486),
    "VFPLUS": (0.7455, 0.0139, 2.4428),
    "ALJAMAAH": (1.0517, 0.3635, 2.0069),
    "ENTRANT": (1.4844, 0.0000, 7.6657),
}
GOLDEN_POOLS: dict[str, tuple[float, float, float]] = {
    "Black African": (53.3946, 46.6306, 59.2600),
    "Coloured": (9.5584, 7.4025, 12.0513),
    "Indian/Asian": (6.4578, 5.1263, 8.1754),
    "White": (29.1047, 24.7557, 33.7705),
}
