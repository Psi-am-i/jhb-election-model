...
GOLDEN_PARTIES: dict[str, tuple[float, float, float]] = {
    "ANC": (23.2186, 13.3778, 33.7358),
    "DA": (26.4551, 20.5651, 32.7416),
    "EFF": (10.0606, 3.4968, 19.2455),
    "ASA": (11.4387, 4.9641, 19.9210),
    "MK": (8.0737, 2.3301, 15.9807),
    "PA": (4.7133, 2.9495, 6.7151),
    "VFPLUS": (0.7592, 0.0110, 2.6443),
    "ALJAMAAH": (1.0619, 0.3579, 2.0170),
    "ENTRANT": (1.4859, 0.0000, 7.7694),
}
GOLDEN_POOLS: dict[str, tuple[float, float, float]] = {
    "Black African": (51.2689, 44.9361, 57.2075),
    "Coloured": (10.1505, 7.9654, 12.7668),
    "Indian/Asian": (5.7578, 4.4199, 7.4461),
    "White": (31.3369, 26.6735, 36.2983),
}
