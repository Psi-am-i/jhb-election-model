...
| `superseded-docs/Graph Engineering.txt` | a generic essay on LLM agent workflow design | reading material, not a project document; its conclusions are in `ARCHITECTURE-PROPOSAL.md` |
