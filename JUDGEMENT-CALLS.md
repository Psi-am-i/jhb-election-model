...
⚠️ **FALSE AT 2026 AS OF 2026-09-22 — MODEL-LOG §1.251.** The lists were published and pasted (`[roster.wards]`), and the lever is still live: nothing wires the declared slates into `levels.contestation`, and the liveness test covers only 2021. Left as written until the fix lands, so the claim and its correction change together.
